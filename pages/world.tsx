...
export async function getServerSideProps(context: any) {
  ...
  const ticker = (
    await (
      await fetch("https://api1.fake.fm/ticker", {
        method: "GET",
        mode: "cors",
        headers: {
      ...
      <div className={styles.MainContainer}>
        <div className={styles.window}>
          ...
          <div className={styles.mainwindow}>
            ...
            <img
              className={styles.fakeworldlogo}
              src="/fakeworld3.webp"
              alt=""
            />
            <div className={styles.firstline}>
              <div className={styles.navbar}>
                ...
                <p className={styles.navbarabout}>
                  Cultural Architect, Public Menace, and Developer/Designer
                  Dabbling in Web3, Automation, and the Future of Business
                </p>
                <br />
                ...
                <ul>
                  <li>
                    <a
                      href="https://twitter.com/1fakeworld"
                      target="_blank"
                  ...
                  <li>
                    <a
                      href="https://github.com/fakeecity"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                  ...
                  <li>
                    <a
                      href="https://discordapp.com/users/259094106356187137"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
              ...
              <div className={styles.ticker}>
                ...
                <p
                  style={
                    ticker.priceUp ? { color: "limegreen" } : { color: "red" }
                  }
                >
                  <b>${ticker.price.toFixed(2)}</b>
                </p>
                <p style={{ color: "white" }}>US Public Debt (Trillions)</p>
                <p
                  style={
                    ticker.debtUp ? { color: "limegreen" } : { color: "red" }
                  }
                >
                  <b>${(ticker.debt / 1000000000000).toFixed(3)}</b>
                </p>
                <p style={{ color: "white" }}>Doomsday Clock</p>
                <p style={{ color: "#b9b9b9" }}>
                  <b>{ticker.midnight} seconds to midnight</b>
                </p>
              </div>
            </div>
          </div>
